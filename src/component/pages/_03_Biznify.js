...
import Biznify_1 from ".././../images/ispDigital_1.png";
import Biznify_2 from ".././../images/ispDigital_2.png";
import Biznify_3 from ".././../images/ispDigital_3.png";
import Biznify_4 from ".././../images/ispDigital_4.svg";
import Biznify_5 from ".././../images/ispDigital_5.png";
export class _03_Biznify extends Component {
        ...
        <div id='service_details' className='text-center lg:text-left ' style={{ backgroundColor: "#EDF0F8" }}>
          <div className='px-4 md:px-16 py-4 lg:px-32 lg:py-10  lg:mb-10 2xl:px-[27%]'>
            <div id='bradcrumbs' className='hidden mt-6 md:block  mx-4 bg-white w-fit '>
              <ul className='flex text-base text-web-color font-semibold'>
                ...
                <li className='px-6 py-2 me-4'>Biznifys</li>
              </ul>
            </div>
            <div className='px-4 py-10   lg:mt-20'>
              <div className='grid grid-cols-1 lg:grid-cols-2'>
                <div >
                  <h3 className='text-web-color text-xl md:text-3xl lg:text-4xl font-bold'>Biznify - An ISP Management & Billing Solution</h3>
                ...
                <div className='mt-4 mx-auto'>
                  <img src={Biznify_1} alt="" className='md:mx-6 rounded-lg' />
                </div>
              </div>
            </div>
          </div>
          <div className='px-4 md:px-16 py-16 bg-white lg:px-32 lg:pt-20 lg:pb-10 2xl:px-[27%]'>
            <div className='grid grid-cols-1 lg:grid-cols-2'>
              <div className='mx-auto'>
                <img src={Biznify_2} alt="" className='rounded-lg' />
              </div>
          ...
          <div className='px-4 md:px-16 pb-16 bg-white lg:px-32 lg:pb-20 lg:pt-10 2xl:px-[27%]'>
            <div className='grid grid-cols-1 lg:grid-cols-2'>
              ...
              <div className='mx-auto'>
                <img src={Biznify_3} alt="" className='rounded-lg' />
              </div>
            </div>
          </div>

          <div id='knowMOre_about_ispDigital' className='px-4 md:px-16 py-20 lg:px-32 lg:py-20 2xl:px-[27%]' style={{ backgroundColor: "#EDF0F8" }}>
            <h1 className='text-center text-web-color font-semibold text-xl md:text-3xl lg:text-4xl'>Know More About Biznify</h1>
            <div className='mt-10 grid grid-cols-1 lg:grid-cols-2'>
              <div className='mx-auto'>
                <img className='h-full rounded-lg' src={Biznify_4} alt="" />
              </div>
          ...
          <div className='px-4 md:px-16 py-14 bg-white lg:px-32 lg:pb-20 lg:pt-10 2xl:px-[27%]'>
            <div className='grid grid-cols-1 lg:grid-cols-2'>
              ...
              <div className='mx-auto'>
                <img src={Biznify_5} alt="" className='rounded-lg' />
              </div>
            </div>
          </div>
        </div>
